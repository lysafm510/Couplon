...
# path1 = "20220801_center4_K1K2_0.001"
# path2 = "20220814_center4_K1K2_0.002"
# path3 = "20220814_center4_K1K2_0.003"
# path4 = "20220811_center4_K1K2_0.005"
# path5 = "20220801_center4_K1K2_0.01"
# path6 = "20220801_center4_K1K2_0.02"
# path7 = "20220801_center4_K1K2_0.05"
# path8 = "20220704_center4_K1K2_0.1"
# path9 = "20220709_DCAJSR_1"

path1 = "20220801_center4_K1K2_0.001"
path2 = "20220814_center4_K1K2_0.002"
path3 = "20220811_center4_K1K2_0.005"
path4 = "20220801_center4_K1K2_0.01"
path5 = "20220709_DCAJSR_1"
...
# label_list = ["1", "0.1", "0.05", "0.02", "0.01", "", "", "", ""]
# label_list = ["0.1 %", "0.2 %", "0.5 %", "1 %", "100 %"]
# label_list = ["0.1 %", "0.2 %", "0.3 %", "0.5 %", "1 %", "2 %", "5 %", "10 %", "100 %"]
# label_list = ["DCAF = 2*10^4", "K1 = 488, K2 = 195.2", "(1)&(2)","a"]
# label_list = ["2 RyRs, DCARYR * 200%", "4 RyRs, DCARYR * 100%"]
# label_list = ["0.1 %", "1 %", "10 %", "100 %"]

# label_list = ["25 %", "50 %", "75 %", "100 %"]
# label_list = ["center 4 RyRs", "random 4 RyRs"]
# label_list = ["20 %", "25 %", "33 %", "50 %", "100 %"]
# label_list = ["4 RyRs", "6 RyRs", "8 RyRs"]
# label_list = ["1 %", "10 %", "20 %", "50 %", "100 %"]
...
def plot(label_list, type, filename, title, paths):
    ...
    if type == "fn":
        ...
        # figure_title = "[Ca] - Caffine - adjust the number of RyRs"
    else:
        figure_title = "[CaF] - adjust parameter \"" + parameter + "\""
        # figure_title = "[CaF] - adjust 4RyRs positions"
        # figure_title = "[CaF] - Caffine - adjust the number of RyRs"
    plt.title(figure_title, fontsize=14)
    plt.legend(labels=label_list, fontsize=11)
    ...
    # plt.savefig("../figure/line/" + date_str + "_" + type + ".png")
    # plt.savefig("../figure/line/" + date_str + "_" + figure_title + ".png")
    plt.show()
